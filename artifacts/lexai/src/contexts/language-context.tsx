...
const translations: Record<Language, Translations> = {
  ...
  ar: {
    ...
    landing: {
      ...
      headline1: "القانون لصالحك",
      headline2: "دائماً وفوراً",
  ...
  it: {
    ...
    chat: {
      ...
      pdfAutoPrompt: "Leggi attentamente questo documento, riassumi il suo contenuto e poi chiedimi cosa voglio sapere, analizzare o verificare.",
      submitButton: "Invia",
  ...
  no: {
    ...
    chat: {
      ...
      analyzeButton: "Analyser",
      pdfAutoPrompt: "Les dette dokumentet nøye, oppsummer innholdet og spør meg deretter hva jeg vil vite, analysere eller verifisere.",
      submitButton: "Send",
  ...
  pl: {
    ...
    chat: {
      ...
      pdfAutoPrompt: "Przeczytaj uważnie ten dokument, podsumuj jego treść, a następnie zapytaj mnie, co chcę wiedzieć, analizować lub zweryfikować.",
      submitButton: "Wyślij",
