...
const translations: Record<Language, Translations> = {
  en: {
    ...
    landing: {
      ...
      subtitle: "AI expertise across EU, US, Arabic & Moroccan law.\nExact article citations and authoritative case law.\nSenior-partner-level answers, delivered instantly.\nAll legal domains and court procedures covered.\nBar & prosecutor exam preparation included.",
  ...
  fr: {
    ...
    landing: {
      ...
      subtitle: "Expertise IA en droit UE, US, arabe et marocain.\nCitations exactes d'articles de loi et de jurisprudence.\nRéponses au niveau d'un associé senior, instantanées.\nTous les domaines juridiques et procédures couverts.\nPréparation aux concours Avocat et Procureur.",
  ...
  ar: {
    ...
    landing: {
      ...
      headline2: "عنه، فوراً.",
      subtitle: "خبرة ذكاء اصطناعي في القانون الأوروبي والأمريكي والعربي والمغربي.\nاستشهادات دقيقة بمواد القانون والسوابق القضائية.\nردود بمستوى شريك أول، فورية.\nجميع المجالات القانونية والإجراءات القضائية.\nالتحضير لمباراة المحاماة والنيابة العامة.",
