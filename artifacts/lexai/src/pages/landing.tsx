      ...
      <section className="relative pt-12 pb-24 lg:pt-16 lg:pb-32 overflow-hidden border-b border-border bg-gradient-to-b from-background to-secondary/20">
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-[31px] lg:text-7xl font-serif font-bold tracking-tight text-foreground leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              {isSignedIn ? (
                <div className="flex items-center gap-3">
                  <Link href="/chat">
                    <Button size="lg" className="h-14 px-8 text-base font-medium shadow-xl">
